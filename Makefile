...
compile:
	g++-7 -std=c++11 -Wall trafficfile.cpp trafficfile.h gate.cpp gate.h connection.cpp connection.h controller.cpp controller.h flow.h flow.cpp packet.cpp packet.h switch.cpp switch.h a3sdn.cpp -o a3sdn
