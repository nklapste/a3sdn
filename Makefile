...
allFiles = README.md LICENSE Makefile gate.h gate.cpp connection.cpp connection.h controller.cpp controller.h flow.h  flow.cpp packet.cpp packet.h \
            switch.cpp switch.h a3sdn.cpp tf1.txt tf2.txt tf3.txt trafficfile.cpp trafficfile.h address.cpp address.h

compile:
	g++-7 -std=c++11 -Wall address.cpp address.h trafficfile.cpp trafficfile.h gate.cpp gate.h connection.cpp connection.h controller.cpp controller.h flow.h flow.cpp packet.cpp packet.h switch.cpp switch.h a3sdn.cpp -o a3sdn
